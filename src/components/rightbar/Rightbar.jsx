...
export default function Rightbar(props) {
	const { user } = props
	const friendsArray = [
		{ name: "Trương Thị Thu Thảo ", url: "https://bom.so/6unBRC" },
		{ name: "Thúy Ngân", url: "https://bom.so/6unBRC" },
		{ name: "Ngọc Diễm", url: "https://bom.so/6unBRC" },
		{ name: "Hoàng Đức", url: "https://bom.so/6unBRC" },
		{ name: "Trương Thủy", url: "https://bom.so/6unBRC" },
		{ name: "Minh Thư", url: "https://bom.so/6unBRC" },
		{ name: "Thu Thảo", url: "https://bom.so/6unBRC" },
		{ name: "Thúy Ngân", url: "https://bom.so/6unBRC" },
		{ name: "Ngọc Diễm", url: "https://bom.so/6unBRC" },
		{ name: "Hoàng Đức", url: "https://bom.so/6unBRC" },
		{ name: "Trương Thủy", url: "https://bom.so/6unBRC" },
